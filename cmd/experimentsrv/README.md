...
<pre><code><b>export AUTH0_DOMAIN=cognizantai.auth0.com
...
export AUTH0_TOKEN=$(curl -s --request POST --url 'https://cognizantai.auth0.com/oauth/token' --header 'content-type: application/json' --data '{ "client
